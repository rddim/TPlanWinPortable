...
user in an INI file next to TPlanWinPortable.exe called TPlanWinPortable.ini.
...
copy AppNamePortable.ini from this directory to TPlanWinPortable.ini next to
TPlanWinPortable.exe. The options in the INI file are as follows:
